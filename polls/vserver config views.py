...
def last(request):
    ...
    #print(rank)
    #return HttpResponse("Hello, world!")
    return HttpResponse("http://ocr.zunamelt.com"+rank)
...
def imgtotext(request):
    ...
    #URL = "http://ocr.zunamelt.com"+rank

    #with urllib.request.urlopen(URL) as url:
    #    with open('/var/www/kyc/id/temp.jpg', 'wb') as f:
    #        f.write(url.read())
    #file_name = Image.open('temp.jpg')
    #file_name = '/var/www/kyc/id/temp.jpg'
    file_name = '/var/www/kyc/id'+rank
...
def xml(request):
    ...
    #with urllib.request.urlopen(URL) as url:
    #    with open('/var/www/kyc/id/temps.jpg', 'wb') as f:
    #        f.write(url.read())
    #file_name = '/var/www/kyc/id/temps.jpg'
    file_name = '/var/www/kyc/id'+rank
    ...
    with open('/var/www/kyc/id/media/xml/test.xml',mode ='w+b') as file:
        file.write(hocr)
        file.close
    return HttpResponse("Hello, world!")